...
const Testimonials = () => {
    ...
    return (
        <motion.div initial={{ opacity: 0, x: 100 }} transition={{
            duration: 1
        }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} className='container mx-auto py-10 lg:px-32 w-full overflow-hidden' id='Testimonials'>
            ...
            <div className="flex flex-wrap justify-center gap-8">
                {testimonialsData.map((testimonial, i) => (
                    <div className="max-w-[340px] border shadow-lg rounded px-8 py-12 text-center" key={i}>
                        ...
                        <div className="flex justify-center gap-1 text-red-500 mb-4">
                            {Array.from({ length: testimonial.rating }, (item, i) => (
                                <img src={assets.star_icon} alt="" key={i} />
                            ))}
                        </div>
