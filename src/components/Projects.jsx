...
const Projects = () => {
    ...
    return (
        <motion.div initial={{opacity:0,x:-200}} transition={{
            duration:1
        }} whileInView={{opacity:1,x:0}} viewport={{once:true}}  className='container mx-auto py-4 pt-20 px-4 sm:px-6 lg:px-32 my-20 w-full overflow-hidden' id='Projects'>
            ...
            <p className='text-center text-gray-700 mb-8 max-w-80 mx-auto'>Crafting Spaces, Building Legacies-Explore Our Portifolio</p>
                ...
                >
                    {projectsData.map((project, i) => (
                        <div className="relative flex-shrink-0 w-full sm:w-1/4" key={i}>
                            <img src={project.image} alt={project.title} className='w-full h-auto mb-14 object-cover' />
